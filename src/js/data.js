...
dataSource.products = {
  chiaPudding: {
    ...
    images: [
      ...
      '<img class="flavour-mint active" src="images/flavour/oat.svg" alt="oat">',
      '<img class="flavour-acai active" src="images/flavour/acai.svg" alt="acai">',
      '<img class="flavour-cacao active" src="images/flavour/cacao.svg" alt="cacao">',
      '<img class="flavour-mint active" src="images/flavour/mint.svg" alt="mint">',
      '<img class="ingredients-vanilla active" src="images/ingredients/vanilla.svg" alt="vanilla">',
      ...
      '<img class="ingredients-blueberries active" src="images/ingredients/blueberry.svg" alt="blueberry">',
      '<img class="ingredients-strawberries active" src="images/ingredients/strawberry.svg" alt="strawberry">',
      '<img class="ingredients-almounds active" src="images/ingredients/almound.svg" alt="almound">',
    ],
    params: {
      dairy: {
        label: 'Dairy',
      ...
      flavour: {
        ...
        type: 'radios',
        options: {
          oat: { label: 'Oat', price: 3, default: true },
          mint: { label: 'Mint', price: 5 },
          chocolate: { label: 'Chocolate', price: 4 },
          acai: { label: 'Acai Powder', price: 5 },
        },
      },
      sugar: {
        label: 'Sugar',
      ...
      ingredients: {
        ...
        type: 'checkboxes',
        options: {
          vanilla: { label: 'Vanilla', price: 3, default: true },
          orange: { label: 'Orange', price: 4 },
          banana: { label: 'Banana', price: 5 },
  ...
  oatmeal: {
    ...
    images: [
      ...
      '<img class="ingredients- active" src="images/ingredients/chocolate.svg" alt="chocolate">',
      '<img class="ingredients-vanilla active" src="images/ingredients/vanilla.svg" alt="vanilla">',
      '<img class="ingredients-vanilla active" src="images/ingredients/hezelnut.svg" alt="hezelnut">',
      '<img class="ingredients-oranges active" src="images/ingredients/orange.svg" alt="orange">',
      '<img class="ingredients-bananas active" src="images/ingredients/banana.svg" alt="banana">',
      '<img class="ingredients-kivi active" src="images/ingredients/kivi.svg" alt="kivi">',
      '<img class="ingredients-blueberries active" src="images/ingredients/blueberry.svg" alt="blueberry">',
  ...
  soup: {
    ...
    images: [
      ...
      '<img class="soup-chili active" src="images/soups/chilisoup.svg">',
