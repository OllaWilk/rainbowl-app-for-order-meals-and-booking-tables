...
dataSource.products = {
  chiaPudding: {
    ...
    images: [
      '<img class="active" src="menu/images/flavour/bowl.svg" alt="bowl">',
      '<img class="flavour-milky" src="menu/images/flavour/milky.svg" alt="milky">',
      '<img class="flavour-acai" src="menu/images/flavour/acai.svg" alt="acai">',
      '<img class="flavour-cocoa" src="menu/images/flavour/cocoa.svg" alt="cocoa">',
      '<img class="flavour-mint " src="menu/images/flavour/mint.svg" alt="mint">',
      '<img class="ingredients-vanilla " src="menu/images/ingredients/vanilla.svg" alt="vanilla">',
      '<img class="ingredients-orange " src="menu/images/ingredients/orange.svg" alt="orange">',
      '<img class="ingredients-banana " src="menu/images/ingredients/banana.svg" alt="banana">',
      '<img class="ingredients-kivi " src="menu/images/ingredients/kivi.svg" alt="kivi">',
      '<img class="ingredients-blueberry " src="menu/images/ingredients/blueberry.svg" alt="blueberry">',
      '<img class="ingredients-stravberry " src="menu/images/ingredients/strawberry.svg" alt="strawberry">',
      '<img class="ingredients-almound " src="menu/images/ingredients/almound.svg" alt="almound">',
      '<img class="ingredients-cinnamon " src="menu/images/ingredients/cinnamon.svg" alt="cinnamon">',
    ],
    params: {
      ingredients: {
        label: 'Ingredients',
  ...
  oatmeal: {
    ...
    images: [
      '<img class="active" src="menu/images/flavour/bowl.svg" alt="bowl">',
      '<img class="active" src="menu/images/ingredients/oat.svg" alt="oat">',
      '<img class="ingredients-chocolate " src="menu/images/ingredients/chocolate.svg" alt="chocolate">',
      '<img class="ingredients-vanilla " src="menu/images/ingredients/vanilla.svg" alt="vanilla">',
      '<img class="ingredients-hezelnut " src="menu/images/ingredients/hezelnut.svg" alt="hezelnut">',
      '<img class="ingredients-orange " src="menu/images/ingredients/orange.svg" alt="orange">',
      '<img class="ingredients-banana " src="menu/images/ingredients/banana.svg" alt="banana">',
      '<img class="ingredients-kivi " src="menu/images/ingredients/kivi.svg" alt="kivi">',
      '<img class="ingredients-apple " src="menu/images/ingredients/apple.svg" alt="apple">',
      '<img class="ingredients-blueberry " src="menu/images/ingredients/blueberry.svg" alt="blueberry">',
      '<img class="ingredients-strawberry" src="menu/images/ingredients/strawberry.svg" alt="strawberry">',
      '<img class="ingredients-cinnamon " src="menu/images/ingredients/cinnamon.svg" alt="cinnamon">',
      '<img class="ingredients-almound " src="menu/images/ingredients/almound.svg" alt="almound">',
    ],
    params: {
  ...
  soup: {
    ...
    images: [
      '<img class="soups-broccoli active" src="menu/images/soups/broccoli.svg">',
      '<img class="soups-chili " src="menu/images/soups/chilisoup.svg">',
      '<img class="soups-pumpkin " src="menu/images/soups/pumpkin.svg">',
    ],
    params: {
      soups: {
        label: 'soup',
